...
const Insertar = () => {
    ...
    const enviar = async (e : any) => {
        ...
        try {
            ...
            await clientAxios.post<ArticuloModify[]>(uri, articulo)
                .then((response : any) => {
            ...
            if (error.response.status == 400) {
                establecerAlerta('El codigo ya se encuentra registrado','mensaje-error');
            } else {
    ...
    return (
        <div className='container mt-5 mb-5'>
            <div className='row'>
                <h1 className='text-center mb-5'>Insertar articulo</h1>
            </div>
            ...
            <form className='col-md-10 col-lg-8 caja'>
                ...
                <div className="row mb-2">
                    <div className='col-12 col-md-2'>
                        <label htmlFor="cantidadArticulo">Cantidad Inicial</label>
                    </div>
                    <div className='col-12 col-md-10'>
                        <input type="number" className="form-control" id="cantidadArticulo" aria-describedby="cantidadAyuda" placeholder="Cantidad Inicial" name='cantidad' onChange={modificarCampos} value="0"/>
                    </div>
                </div>
